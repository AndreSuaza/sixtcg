    ...
    <div className="bg-slate-50 text-gray-700 pb-10">
      ...
      <div className="how-to-play md:mx-24 mx-4 text-2xl">
        ...
        <section className="grid xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 text-center">
          ...
          <iframe className="mx-auto md:w-[560px] md:h-[315px] sm:w-[280px] sm:h-[157px]" src="https://www.youtube.com/embed/NE6FF2iIkHU?si=grYNYcg2zciwoZuW" title="Aprende con Wizard Como Jugar Souls In Xtinction" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
          </div>
          <div className="mx-auto">
          <h2 className="my-6">Aprende con HerosBran</h2>
          <iframe className="mx-auto md:w-[560px] md:h-[315px] sm:w-[280px] sm:h-[157px]" src="https://www.youtube.com/embed/hbVOkDLkFvM?si=iL869mpe89rplJiw" title="Aprende con Herosbran Como Jugar Souls In Xtinction" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
          </div>
        </section>
