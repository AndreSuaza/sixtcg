...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
            url: 'https://soulsinxtinction.com/productos/mar.jpg',
            width: 800,
            height: 600,
            ...
            <Title title="Mazo Angeles" subtitle="Amanecer Celestial"/>
                ...
                <div className="bg-white px-10 py-10 mb-10">
                    ...
                    <section className="grid lg:grid-cols-6 md:grid-cols-4 grid-cols-1 gap-5 my-16">
                        ...
                        <Link className="lg:col-span-6 md:col-span-4 sm:col-span-1 w-96 m-auto" href={'/cartas?&products=ME2#cards'}>
