...
export default function Rey() {
  return (
    <section className="mt-10 lg:mx-20">
      ...
      <div className="bg-[url('/events/rey-rashomon.jpg')] h-96 bg-no-repeat bg-right-bottom pt-10 relative border-b-2 border-indigo-500"
      ...
      <div className="bg-gray-50 text-zinc-600 text-lg pt-20 p-10 mx-10 flex-none font-light font-sans">
        <article>
          <h2 className="capitalize text-center text-indigo-500 text-4xl mb-20 font-medium lg:mx-20">Iniciamos el competivo de Soul in Xtincion con toda!</h2>
